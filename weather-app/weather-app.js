      ...
      if (keyCode == 13) {
        ...
        weatherAPIObj.invokeURL()
          .then((responseJSON) => {
            ...
            temperatureElement.innerText = responseObj.TEMPERATURE + " \xB0C";
            ...
            lowHighTempElement.innerText = `${responseObj.LOW_TEMPERATURE + " \xB0C"} / ${responseObj.HIGH_TEMPERATURE + " \xB0C"}`
